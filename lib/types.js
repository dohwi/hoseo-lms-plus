 ...
 * @property {boolean} [isCourseNotice] - 강좌 공지 게시판 여부
 */

/**
 * @typedef {Object} CourseNotice
 * @property {string} courseId - 강좌 ID
 * @property {string} courseName - 강좌명
 * @property {string} href - 공지 게시판 URL
 * @property {string} titleHtml - 공지 게시판 표시명 HTML
 */
 ...
 * @property {CourseNotice[]} notices - 강좌 공지 게시판 배열
 ...
 * @property {CourseNotice[]} allNotices - 전체 강좌 공지 게시판
