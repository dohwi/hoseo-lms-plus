(function (global, factory) {
    ...
    function create(runtime) {
        ...
        async function fetchCourseData(courseId, isIrregular) {
            ...
            noticeResults.forEach(function (result) {
                if (result.text) {
                    noticeActivities.push(...parsers.parseUbboardNoticePage(result.text, courseId, courseName, attendanceResult.periodMap, BASE_URL));
