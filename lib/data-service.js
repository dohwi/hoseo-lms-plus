    ...
    function create(runtime) {
        ...
        async function fetchCourseData(courseId, isIrregular) {
            ...
            if (endpoints.some((endpoint) => endpoint.sessionExpired)) {
                return { courseId: courseId, courseName: courseTitle, items: [], assigns: [], activities: [], notices: [], warnings: [], sessionExpired: true };
            }
            ...
            const sourceActivities = endpoints[3].text
                ...
                : [];
            const notices = sourceActivities
            ...
            const activities = buildActivities(courseId, courseName, sourceActivities, items, assignments, quizzes);
