(function (global, factory) {
    ...
    function clearChildren(target) {
        Array.from(target.querySelectorAll('*')).reverse().forEach(function (element) {
            if (typeof element.__lmsDispose === 'function') element.__lmsDispose();
        });
    ...
    function createCourseContext(doc, courseName) {
    ...
    return {
        ...
        createCourseContext: createCourseContext,
