(function (global, factory) {
    ...
    function create(options) {
        ...
        function renderDashboardData(data) {
            ...
            if (!sortedWeeks.length && (data.allNotices || []).length) sortedWeeks.push(core.OTHER_WEEK_NUM);
            ...
            const notices = (data.allNotices || []).filter(function (notice) {
                if (!notice.href || seenNoticeUrls.has(notice.href)) return false;
                seenNoticeUrls.add(notice.href);
                return true;
        ...
        async function fetchAndRender(courseInfoList, forceRefresh) {
            ...
            if (!data || (!data.allItems.length && !data.allAssigns.length && !data.allActivities.length && !(data.allNotices || []).length)) {
