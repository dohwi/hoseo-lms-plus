    ...
    function create(options) {
        ...
        function renderDashboardData(data) {
            ...
            renderState.render = function () {
                ...
                const activities = core.dedupActivities((activitiesByWeek.get(week) || []).slice());
        ...
        async function fetchAndRender(courseInfoList, forceRefresh) {
            ...
            const canUseCache = context.userContext.userId && context.userContext.userId !== 'anonymous';
            const cached = !forceRefresh && canUseCache ? await cacheStore.get(context.cacheKey) : null;
            ...
            if (!data) {
                try {
                    ...
                    if (!data.sessionExpired && canUseCache) await cacheStore.set(context.cacheKey, data);
                } catch (error) {
